...
public class MainActivity extends AppCompatActivity {
    ...
    public class AndroidBridge {
        ...
        // Save JSON backup to Downloads/VyaparBackup/ — SAME FILE OVERWRITE
        @JavascriptInterface
        public void saveBackupFile(String jsonData, String fileName) {
            new Thread(() -> {
                try {
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                        // Android 10+ : Delete old file first, then write fresh (overwrite)
                        String relPath = Environment.DIRECTORY_DOWNLOADS + "/VyaparBackup/";
                        ...
                        // Android 9- : FileOutputStream(file, false) = overwrite
                        File dir = new File(
                    ...
                    runOnUiThread(() -> Toast.makeText(MainActivity.this,
                        "✅ Backup Updated!\nDownloads/VyaparBackup/" + fileName,
